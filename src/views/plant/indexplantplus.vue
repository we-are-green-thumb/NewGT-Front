<template>
    <div>
        <form>
  <fieldset>
    <legend>식물을 등록하세요</legend>
    <div class="form-group row">
      <label for="staticEmail" class="col-sm-2 col-form-label">별명</label>
      <div class="col-sm-10">
        <input type="text"  class="form-control" id="staticEmail" placeholder="레몬">
      </div>
    </div>
    ...
    <div class="form-group row">
      <label for="staticEmail" class="col-sm-6 col-form-label">마지막으로 물을 언제주셨나요</label>
      <div class="col-sm-10">
        <input type="text"  class="form-control" id="staticEmail" placeholder="1">
      </div>
    </div>
    <div class="form-group row">
